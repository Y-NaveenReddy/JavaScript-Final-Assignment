$(document).ready(function () {
  ...
  var clothing = $("<a>")
    .attr({ href: "#clothing-section", id: "clothing", class: "m-link" })
    .html("clothing");

  var accessories = $("<a>")
    .attr({ href: "#accessroy-section", id: "accessories", class: "m-link" })
    .html("accessories");
  ...
  var clothingSection = $("<section>").attr({
    id: "clothing-section",
    class: "product-section",
  });

  var clothinHeading = $("<h3>")
    .attr("class", "section-heading")
    .html("Clothing for Men and Women");

  var clothingContainer = $("<div>").attr({
  ...
  var accessorySection = $("<section>").attr({
    id: "accessroy-section",
    class: "product-section",
  });

  var accessoryHeading = $("<h3>")
    .attr("class", "section-heading")
    .html("Accessories for Men and Women");

  var accessoryContainer = $("<div>").attr({
  ...
  function createHomePageProducts(details) {
    ...
    var imgLink = $("<a>").attr(
      "href",
      "./product details/product.html?p=" + details.id
    ); //
