$(document).ready(function () {
  ...
  var clothing = $("<a>")
    .attr({
      href: "../index.html#clothing-section",
      id: "clothing",
      class: "m-link",
    })
    .html("clothing"); //clothing link

  var accessories = $("<a>")
    .attr({
      href: "../index.html#accessory-container",
      id: "accessories",
      class: "m-link",
    })
  ...
  var footerHeading = $("<p>")
    ...
    .html("Online Store");
  var link1 = $("<a>")
    .attr({ href: "../index.html#clothing-section", class: "footer-link" })
    .html("Men Clothing");
  var link2 = $("<a>")
    .attr({ href: "../index.html#clothing-section", class: "footer-link" })
    .html("Women Clothing");
  var link3 = $("<a>")
    .attr({ href: "../index.html#accessroy-section", class: "footer-link" })
    .html("Men Accessories");
  var link4 = $("<a>")
    .attr({ href: "../index.html#accessroy-section", class: "footer-link" })
    .html("Women Accessories");
  footerdiv1.append(footerHeading, link1, link2, link3, link4);
  var footerdiv2 = $("<div>");
  var footerHeading2 = $("<p>")
    .attr("class", "footer-heading")
    .html("Helpful Links");
  var link5 = $("<a>")
    .attr({ href: "../index.html", class: "footer-link" })
    .html("Home");
  var link6 = $("<a>")
    .attr({ href: "../index.html", class: "footer-link" })
    .html("About");
  ...
  var projectLogo = $("<img>").attr({
    src: "../images/OKAY6Fl.png",
    alt: "project Logo",
    id: "project-logo",
  });
  $("footer").prepend(
  ...
  $.get(
    ...
    function (data, status) {
      ...
      var productbrand = $("<h2>")
        ...
        .html(data.brand);
      var productRate = $("<h4>")
        .attr("class", "product-rate")
        .html("Price: Rs ");
      var rate = $("<span>").html(data.price);
      productRate.append(rate);
      var productDescription = $("<h4>")
        .attr("class", "product-rate")
        .html("Description");
      var descriptionPara = $("<p>")
        .attr("class", "descr-para")
        .html(data.description);
      var productPreviewImg = $("<h4>")
        .attr("class", "preview-img-product")
